...
- Documented the zero-asset preview regression and rebalance exit-failure guardrails for issues #541 and #542, and clarified the storage-only `set_user_strategy` semantics and no-harvest design notes in the docs for issues #500 and #496.
